REM Installs Neosoft's IntelliJ configs into your user configs.
@echo off
echo Installing Neosoft IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'NeosoftJava' or 'NeosoftAndroid'.
exit /b
